        ...
        subEvents.map((SubEvent) => (
          <div key={SubEvent.id} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow bg-white border-gray-300">
            ...
            <div className="p-5">
              ...
              <div onClick={() => navigate('/eventdetails')} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                Read more
